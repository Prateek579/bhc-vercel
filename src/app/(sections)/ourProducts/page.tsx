          ...
          <div className="space-y-6 flex flex-col items-start justify-between sm:space-y-8 lg:space-y-10">
            <div className="flex items-start gap-4 sm:gap-6 lg:gap-8">
              ...
              <div>
                ...
                <p className="text-sm sm:text-[14px] font-[400] leading-[1.6] sm:leading-[1.5] tracking-[0%] text-[#666666]">Vitals Check: BP, Pulse, SpO2, Temperature, BMI</p>
                <p className="text-sm sm:text-[14px] font-[400] leading-[1.6] sm:leading-[1.5] tracking-[0%] text-[#666666]">Basic Diagnostics: Blood Sugar, ECG, Lipid Profile, Hemoglobin</p>
                <p className="text-sm sm:text-[14px] font-[400] leading-[1.6] sm:leading-[1.5] tracking-[0%] text-[#666666]">Nurse Assistance: Guides patient, records EHR</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 sm:gap-6 lg:gap-8">
              ...
              <div>
                ...
                <p className="text-sm sm:text-[14px] font-[400] leading-[1.6] sm:leading-[1.5] tracking-[0%] text-[#666666]">Video Call with Doctor (Internal Medicine)</p>
                <p className="text-sm sm:text-[14px] font-[400] leading-[1.6] sm:leading-[1.5] tracking-[0%] text-[#666666]">Live Data Transmission: ECG, Blood Tests, Stethoscope Readings</p>
                <p className="text-sm sm:text-[14px] font-[400] leading-[1.6] sm:leading-[1.5] tracking-[0%] text-[#666666]">Diagnosis & Printed Prescription</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 sm:gap-6 lg:gap-8">
              ...
              <div>
                ...
                <p className="text-sm sm:text-[14px] font-[400] leading-[1.6] sm:leading-[1.5] tracking-[0%] text-[#666666]">Chronic Disease Identification</p>
                <p className="text-sm sm:text-[14px] font-[400] leading-[1.6] sm:leading-[1.5] tracking-[0%] text-[#666666]">Follow-up Consultation & Specialist Referral</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 sm:gap-6 lg:gap-8">
              ...
              <div>
                <h3 className="text-lg sm:text-xl lg:text-[20px] font-[600] font-['Montserrat'] leading-[120%] sm:leading-[100%] tracking-[0%] align-middle text-[#1A1A1A] mb-2 sm:mb-3">Follow-up & Chronic Care</h3>
                <p className="text-sm sm:text-[14px] font-[400] leading-[1.6] sm:leading-[1.5] tracking-[0%] text-[#666666]">Remote Consultation with Specialist</p>
                <p className="text-sm sm:text-[14px] font-[400] leading-[1.6] sm:leading-[1.5] tracking-[0%] text-[#666666]">Report Analysis & Final Prescription</p>
                <p className="text-sm sm:text-[14px] font-[400] leading-[1.6] sm:leading-[1.5] tracking-[0%] text-[#666666]">Referral to Hospital (if advanced care is needed)</p>
              </div>
            </div>
          </div>
        </div>
