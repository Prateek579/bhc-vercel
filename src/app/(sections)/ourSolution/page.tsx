      ...
      <div className="max-w-screen-2xl mx-auto px-3 sm:px-15 lg:px-22 py-20 md:py-32">
        ...
        <div className="grid md:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 pl-2 sm:pl-4 lg:pl-8">
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className={`bg-white p-4 sm:p-5 lg:p-6 rounded-lg flex items-center space-x-2 sm:space-x-3 lg:space-x-4 cursor-pointer transition-shadow ${activeSol === 1 && 'border-1 border-gray-300'}`} onClick={() => setActiveSol(1)}>
          ...
          {activeSol === 1 && <div className="space-y-8">
          ...
          {activeSol === 2 && <div className="space-y-8">
            <div className="bg-white p-4 sm:p-5 lg:p-6 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
              <div className="flex flex-col items-start space-y-3 sm:space-y-4 lg:space-y-5">
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 flex items-center justify-center bg-[#EBF6FE] rounded-full">
                  <Image src="/icons/sol-2-lgo4.png"
          ...
          {activeSol === 3 && <div className="space-y-8">
            <div className="bg-white p-4 sm:p-5 lg:p-6 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
              <div className="flex flex-col items-start space-y-3 sm:space-y-4 lg:space-y-5">
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 flex items-center justify-center bg-[#EBF6FE] rounded-full">
                  <Image src="/icons/sol-2-lgo4.png"
          ...
          {activeSol === 4 && <div className="space-y-8">
            <div className="bg-white p-4 sm:p-5 lg:p-6 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
              <div className="flex flex-col items-start space-y-3 sm:space-y-4 lg:space-y-5">
                <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 flex items-center justify-center bg-[#EBF6FE] rounded-full">
                  <Image src="/icons/sol-2-lgo4.png"
        ...
        <div className="pl-2 sm:pl-4 lg:pl-8 overflow-hidden">
          <div className="specialty-cards-container pb-4 sm:pb-5 lg:pb-6 space-x-4 sm:space-x-5 lg:space-x-6">
            ...
            <div className="hover:bg-gradient-to-r hover:from-[rgba(24,160,147,0.7)] hover:via-[rgba(18,131,135,0.7)] hover:via-[rgba(11,100,122,0.7)] hover:via-[rgba(6,80,114,0.7)] hover:to-[rgba(0,51,102,0.7)] group w-40 sm:w-44 lg:w-48 bg-white p-4 sm:p-5 lg:p-6 rounded-lg border border-gray-200 flex flex-col items-center space-y-3 sm:space-y-4">
              ...
              <h3 className="text-base sm:text-lg text-gray-500 text-cente group-hover:text-whiter">Dermatology</h3>
            </div>
